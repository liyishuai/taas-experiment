...
lgd = fig.legend(ncol=4, loc='upper right',bbox_to_anchor=(1.0, 1.15))
tso_latency.set_xlabel('Execution Time')
tso_latency.set_ylabel('Latency (ms)')
# taas_latency.set_ylabel('Latency (ms)')
tso_latency.yaxis.set_label_coords(1.1, 1.2)
tso_throughput.set_ylabel('Timestamp / s')
# taas_throughput.set_ylabel('Throughput')
tso_throughput.yaxis.set_label_coords(-0.1, 1.2)
...
fig.savefig('result.pdf', format='pdf',bbox_inches='tight',bbox_extra_artists=(lgd,))