...
ax.errorbar(x - width/2, median1, yerr=p99_1, fmt='none', capsize=5, label='TiDB-PD P99')
...
ax.errorbar(x + width/2, median2, yerr=p99_2, fmt='none', capsize=5, label='TaaS P99')

ax.set_ylabel('Latency (ms)')
ax.set_title('Latency in 3AZ')
ax.set_ybound(5.0)
ax.set_yticks([x * 0.5 for x in range(0, 10)])
ax.set_xticks(x)
